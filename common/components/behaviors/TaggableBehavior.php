    ...
    public function afterSave()
    {
        ...
        foreach ($this->_tagValues as $value) {
            ...
            if ($tag === null) {
                ...
                if (isset($this->owner->language_code)) {
                    $tag->language_code = $this->owner->language_code;
                } elseif (Yii::$app->request->get('langCode')) {
                    $tag->language_code = Yii::$app->request->get('langCode');
                } elseif (Yii::$app->request->get('lang')) {
                    $tag->language_code = Yii::$app->request->get('lang');
                } else {
                    $tag->language_code = 'ru';
                }
